...
parser.add_argument('--train_pct', help='Ratio of train data, the rest go to validation (default value: .8)', type=float, default=.8)
...
print('='*50)
print('Confirmed dataset path:', data_dir)
...
# delete if folder exists, then create
for dir in dirs:
...
# train images (randomly chose) and val images
